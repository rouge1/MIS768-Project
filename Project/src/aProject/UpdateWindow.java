...
public class UpdateWindow extends JFrame {
	...
	public UpdateWindow() {
		...
		btnSave.setBounds(242, 261, 89, 23);
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				getDBConnection();
				 ...
				 String sql = "UPDATE caseLocations SET caseNumber = ?, caseType = ?, caseDate = ?, caseLat = ?, caseLong = ?, caseElev = ? WHERE caseID = ?";
				 ...
				 stmt2.setString(2,t);
				 stmt2.setString(3,d);
				 stmt2.setString(4,la);
				 stmt2.setString(5,lo);
				 stmt2.setString(6,el);
				 stmt2.setString(7,i);
			     ...
			     // Display the results.
			     JOptionPane.showMessageDialog(null, rows + " row(s) updated.");
